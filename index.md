<html>
    ...
    <body>
            ...
            function initEmbeddedMessaging() {
                ...
                try {
                    ...
                    embeddedservice_bootstrap.init(
                        '00Ddx0000001gtF',
                        'Github_Chat',
                        'https://legrandav--echochat.sandbox.my.site.com/ESWGithubChat1717393415515',
                        {
        ...
        <script type='text/javascript' src='https://legrandav--echochat.sandbox.my.site.com/ESWGithubChat1717393415515/assets/js/bootstrap.min.js' onload='initEmbeddedMessaging()'></script>
